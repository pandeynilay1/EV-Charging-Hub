...
<!--nav about start-->
    ...
    <!--nav about end-->
     <h1>User Registration</h1>
        ...
        <tr>
          <td><asp:Label Text="first_name"  runat="server" /></td>
          <td><asp:TextBox ID="txtfirst_name" runat="server" /></td>
        </tr>
        <tr>
          <td><asp:Label Text="last_name" runat="server" /></td>
          <td><asp:TextBox ID="txtlast_name" runat="server" /></td>
        </tr>
        <tr>
        ...
        <tr>
                <td><asp:Label Text="reg_number" runat="server"/></td>
          <td><asp:TextBox ID="txtreg_number" runat="server" /></td>
        </tr>
        <tr>
          <td><asp:Label Text="state" runat="server"/></td>
          <td><asp:TextBox ID="txtstate" runat="server" /></td>
        </tr>
        <tr>
          <td><asp:Label Text="city" runat="server"/></td>
        ...
        <tr>
          <td><asp:Label Text="vehicle_type" runat="server"/></td>
          <td><asp:TextBox ID="txtvehicle_type" runat="server" /></td>
             </tr>
