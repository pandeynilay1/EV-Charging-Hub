...
<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="addslots.aspx.cs" Inherits="Registration_form.addslots" %>
...
<body>
    ...
    <tr>
        ...
        <td>
            <asp:TextBox ID="slot_number" runat="server"></asp:TextBox>
        </td>
    </tr>
                    <tr>
    <td>
...
<td>
    <asp:TextBox ID="stationName1" runat="server"  ReadOnly="true"></asp:TextBox>
</td>
</tr>
    <tr>
        <td>
        ...
        <td>
            <asp:TextBox ID="slot_date" runat="server"></asp:TextBox>
        </td>
    </tr>
    <tr>
        <td>
        ...
        <td>
            <asp:TextBox ID="slot_start" runat="server"></asp:TextBox>
        </td>
    </tr>
    <tr>
        <td>
        ...
        <td>
            <asp:TextBox ID="slot_end" runat="server"></asp:TextBox>
        </td>
    </tr>
    <tr>
        <td>
        ...
        <td>
         ...
         <tr>
    <td>
        <label for="slotstatus">Slot Status:</label>
    </td>
    <td>
        <!-- Display the default value for slot_status -->
        <asp:Label ID="slot_status_default" runat="server" Text="open"></asp:Label>
        <!-- Hidden field to hold the actual value for slot_status -->
        <asp:HiddenField ID="defaultSlotStatus" runat="server" Value="open" />
    </td>
</tr>
    ...
    <tr>
        <td colspan="2">
            <asp:Button ID="btnAddSlot" runat="server" Text="Add Slot" OnClick="btnAddSlot_Click" CssClass="green-button" />
        </td>
    </tr>
</table>
</div>
